  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const backendData = {
        ...
        isReservationAvailable: formData.isReservationAvailable,
      };
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 3, border: '1px solid', borderColor: 'divider', borderRadius: 2, bgcolor: 'background.paper', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
                        ...
                        >
                          <Button
                            disableElevation
                            variant={!formData.isReservationAvailable ? "contained" : "text"}
                            color={!formData.isReservationAvailable ? "error" : "inherit"}
                            ...
                            sx={{
                              ...
                              bgcolor: !formData.isReservationAvailable ? 'error.main' : 'transparent',
                              color: !formData.isReservationAvailable ? 'white' : 'text.secondary',
                              '&:hover': {
                                bgcolor: !formData.isReservationAvailable ? 'error.dark' : 'rgba(0,0,0,0.05)'
                              }
                            }}
                          >
                            HAYIR
                          ...
                          <Button
                            disableElevation
                            variant={formData.isReservationAvailable ? "contained" : "text"}
                            color={formData.isReservationAvailable ? "success" : "inherit"}
                            ...
                            sx={{
                              ...
                              minWidth: 100,
                              transition: 'all 0.3s ease',
                              bgcolor: formData.isReservationAvailable ? 'success.main' : 'transparent',
                              color: formData.isReservationAvailable ? 'white' : 'text.secondary',
                              '&:hover': {
                                bgcolor: formData.isReservationAvailable ? 'success.dark' : 'rgba(0,0,0,0.05)'
                              }
                            }}
                          >
                            EVET
